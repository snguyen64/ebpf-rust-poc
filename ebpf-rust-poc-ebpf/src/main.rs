...
use aya_ebpf::{macros::{uprobe, uretprobe}, programs::ProbeContext, programs::RetProbeContext};
...
#[uretprobe]
pub fn track_malloc_ret(ctx: ProbeContext) -> u32 {
...
unsafe fn try_track_malloc_ret(ctx: ProbeContext) -> Result<(), u32> {
